...
export async function POST(req: Request) {
  ...
  const internalHtml = `
    <div style="font-family:Inter,system-ui,sans-serif;color:#1A2033;max-width:600px;margin:0 auto;">
      ...
      <p style="margin-top:24px;color:#5B6470;font-size:13px;">Reminder: client expects 1 to 2 hour response, any time.</p>
    </div>
  `
  ...
  const customerHtml = `
    <div style="font-family:Inter,system-ui,sans-serif;color:#1A2033;max-width:600px;margin:0 auto;background:#F7F5F0;padding:32px 24px;">
      <div style="background:#FFFFFF;border:1px solid #E4E4DD;border-radius:16px;padding:32px;">
        ...
        <p style="color:#5B6470;margin:0 0 24px;line-height:1.6;">Your request is in. A member of the Torvik Hauling team will reach out within <strong style="color:#0B2E5B;">1 to 2 hours</strong> with a free estimate. If you need us sooner, call or text <a href="tel:+12244566607" style="color:#0B2E5B;font-weight:600;">(224) 456-6607</a>.</p>
